...
(function() {
  var boardIsFull, bonus, buildBoard, collapseCells, generateTile, getColumn, getRow, isGameOver, mergeCells, move, moveIsValid, noValidMoves, printArray, randomCellIndices, randomInt, randomValue, setColumn, setRow, showBoard,
  ...
  showBoard = function(board) {
    var col, row, value, _i, _j, _k, _len, _ref;
    for (row = _i = 0; _i <= 3; row = ++_i) {
      for (col = _j = 0; _j <= 3; col = ++_j) {
        _ref = [2000, 4000, 8000, 16000, 32000, 64000, 128000, 256000, 512000, 1024000, 2048000];
  ...
  bonus = function(board) {
    ...
    for (row = _i = 0; _i <= 3; row = ++_i) {
      _results.push((function() {
        ...
        _results1 = [];
        for (col = _j = 0; _j <= 3; col = ++_j) {
          _results1.push(max = Math.max(board[row][col]));
        }
        return _results1;
      })());
    }
